...
const Scrolls = () => {
  ...
  // const scrollWidth = (width - leftToolbarWidth) ** 2 / boardSize.width;
  // const scrollHeight = (height - bottomMenuHeight) ** 2 / boardSize.height;
  ...
  const hy = height - bottomMenuHeight - 12;
  const yMin = 12;
  const yMax = height - bottomMenuHeight - scrollHeight - 18;
